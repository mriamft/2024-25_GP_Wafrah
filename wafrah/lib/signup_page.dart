...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<bool> phoneNumberExists(String phoneNumber) async {
    final url =
        Uri.parse('https://d89b-2001-16a2-db10-b500-4c3a-d071-238f-8ef2.ngrok-free.app/checkPhoneNumber');
  ...
  Future<void> sendOTP(String phoneNumber, String firstName, String lastName,
    ...
    final url = Uri.parse('https://d89b-2001-16a2-db10-b500-4c3a-d071-238f-8ef2.ngrok-free.app/send-otp');
    final response = await http.post(
      url,
      headers: {"Content-Type": "application/json"},
      body: json.encode({'phoneNumber': phoneNumber}),
